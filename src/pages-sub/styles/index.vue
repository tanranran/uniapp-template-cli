  ...
  <view class="min-h-screen bg-gray-100 py-3 dark:bg-[var(--wot-dark-background)]">
    ...
    <demo-block title="字体系统" transparent>
      <view class="rounded-2 bg-white p-4 dark:bg-[var(--wot-dark-background2)]">
        ...
        <view class="space-y-3">
          <view v-for="font in fontExamples" :key="font.name" class="flex items-center justify-between border-b border-gray-100 pb-2 last:border-b-0 dark:border-[var(--wot-dark-border)]" @click="copyCode(font.name)">
    ...
    <demo-block title="交互效果" transparent>
      <view class="space-y-4">
        ...
        <view class="rounded-2 bg-white p-4 dark:bg-[var(--wot-dark-background2)]">
          ...
          <view class="mt-3 rounded bg-gray-100 p-2 text-2.5 text-gray-700 font-mono dark:bg-[var(--wot-dark-background3)] dark:text-[var(--wot-dark-color2)]" @click="copyCode('hover:bg-blue-200 hover:scale-105 transition-all duration-300')">hover:bg-blue-200 hover:scale-105 transition-all duration-300</view>
        </view>
        ...
        <view class="rounded-2 bg-white p-4 dark:bg-[var(--wot-dark-background2)]">
          ...
          <view class="mt-4 flex justify-center">
            <view :class="[animationState ? 'bg-gradient-to-r from-purple-500 to-pink-500 text-white transform rotate-12 scale-110 shadow-lg' : 'bg-gray-100 text-gray-800 transform rotate-0 scale-100 shadow-sm dark:bg-[var(--wot-dark-background3)] dark:text-[var(--wot-dark-color)]']" class="rounded-2 p-6 text-center transition-all duration-500 ease-in-out">
              <text class="text-4 font-bold">动画演示</text>
            </view>
          </view>
          <view class="mt-3 rounded bg-gray-100 p-2 text-2.5 text-gray-700 leading-relaxed font-mono dark:bg-[var(--wot-dark-background3)] dark:text-[var(--wot-dark-color2)]" @click="copyCode('transition-all duration-500 ease-in-out transform rotate-12 scale-110')">transition-all duration-500 ease-in-out\n transform rotate-12 scale-110</view>
        </view>
      </view>
    </demo-block>
    ...
    <demo-block title="响应式设计" transparent>
      <view class="rounded-2 bg-white p-4 dark:bg-[var(--wot-dark-background2)]">
        ...
        <view class="mt-4 rounded bg-gray-100 p-2 text-2.5 text-gray-700 leading-relaxed font-mono dark:bg-[var(--wot-dark-background3)] dark:text-[var(--wot-dark-color2)]" @click="copyCode('grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4')">grid-cols-1 sm:grid-cols-2\n md:grid-cols-3 lg:grid-cols-4</view>
      </view>
    </demo-block>
    ...
    <demo-block title="实用工具类" transparent>
      <view class="space-y-4">
        ...
        <view class="rounded-2 bg-white p-4 dark:bg-[var(--wot-dark-background2)]">
          ...
          <view class="rounded bg-gray-100 p-2 text-2.5 text-gray-700 font-mono dark:bg-[var(--wot-dark-background3)] dark:text-[var(--wot-dark-color2)]" @click="copyCode('block inline flex hidden')">block inline flex hidden</view>
        </view>
        ...
        <view class="rounded-2 bg-white p-4 dark:bg-[var(--wot-dark-background2)]">
          ...
          <view class="mt-3 rounded bg-gray-100 p-2 text-2.5 text-gray-700 font-mono dark:bg-[var(--wot-dark-background3)] dark:text-[var(--wot-dark-color2)]" @click="copyCode('absolute relative top-2 left-2 right-2 bottom-2')">absolute relative top-2 left-2 right-2 bottom-2</view>
        </view>
      </view>
    </demo-block>
